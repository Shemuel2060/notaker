...
public class MainFXMLDocumentController implements Initializable{
	...
	"MainFXMLDocumentController initialized!!");
	...
	@FXML
	/**
	 * brings up a new window to add details about
	 * the new note to add or start writing.
	 */
	...
	/**
	 * brings up a new window to add details about
	 * the new notebook to add or start writing.
	 */
